...
Cube::Cube(GLFWWindowFactory* window):window(window)
{
    ...
    shader = Shader("D:/openGLProject/lab/src/medium/2.2diffuseLight/dependencies/shader.vs", "D:/openGLProject/lab/src/medium/2.2diffuseLight/dependencies/shader.fs");
    lightShader= (Shader("D:/openGLProject/lab/src/medium/2.2diffuseLight/dependencies/lightShader.vs", "D:/openGLProject/lab/src/medium/2.2diffuseLight/dependencies/lightShader.fs"));
    loadTexture();
    setElements();
...
void Cube::loadTexture(){
    std::vector<std::string> path = {"D:/openGLProject/lab/src/medium/2.2diffuseLight/dependencies/logo.png","D:/openGLProject/lab/src/medium/2.2diffuseLight/dependencies/tex.png"};
