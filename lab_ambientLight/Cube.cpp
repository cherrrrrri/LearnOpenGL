...
Cube::Cube(GLFWWindowFactory* window):window(window)
{
    ...
    shader = Shader("D:/openGLProject/ambientLight/shader.vs", "D:/openGLProject/ambientLight/shader.fs");
    lightShader= (Shader("D:/openGLProject/ambientLight/lightShader.vs", "D:/openGLProject/ambientLight/lightShader.fs"));
    loadTexture();
    setElements();
...
void Cube::draw()
{
    std::vector<std::vector<float>> lights = {{0.0f,0.0f,8.0f,1.0f},{5.0f,5.0f,-3.0f,0.5f}};
    shader.use();
...
void Cube::loadTexture(){
    std::vector<std::string> path = {"D:/openGLProject/ambientLight/logo.png","D:/openGLProject/ambientLight/tex.png"};
